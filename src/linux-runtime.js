...
function buildLinuxOutputStartup(dataRva) {
  ...
  E.call_rel(b, 12);             // call overlay at offset 45 (rel32 = 45 - 33 = 12)
  E.xor_rr(b, RDI, RDI);         // xor rdi, rdi (exit code 0)
  b.u8(0x48); b.u8(0xC7); b.u8(0xC0); b.u32(60); // mov rax, 60 (exit syscall)
  b.u8(0x0F); b.u8(0x05);        // syscall
  return b.b.slice(0, b.tell());
}
