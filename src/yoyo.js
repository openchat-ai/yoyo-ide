...
function compileWin(src){
  ...
  function ci(n){const r=P[n];if(r===undefined)return;const c=CODE_RVA+code.tell();E.call_rip(code,r-(c+6));code.iatFixups.push({n,dispPos:code.tell()-4,instrEnd:c+6});}
