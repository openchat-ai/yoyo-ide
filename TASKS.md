...
```
mini-kyc.ty.sha256: cd2bffec671f75f86d40e62a1c5e4cf44c4382260c02086d560cf4e6123d6969
...
- Stage 2 通过之后才做
- mini-kyc2.exe 编译 mini-kyc.ty → mini-kyc3.exe
- 三者必须 bit-identical

### C. Phase 2: 加剩余 opcode emitter

- 当前 mini-kyc.ty 支持 9 个 opcode（`40 FF 30 60 65 66 70 71 41`）
...
[2] node ky-compiler.js mini-kyc.ty → mini-kyc.exe           (gen 1, 87040B)
